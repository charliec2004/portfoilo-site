...
const ProfileCard = forwardRef(function ProfileCard({ tiltHandlers = {} }, ref) {
  return (
    <aside
      ref={ref}
      data-card="profile"
      className="profile-card rounded-card bg-gradient-gold shadow-card-inset flex-1 min-w-[240px] xl:min-w-[400px] h-full overflow-hidden flex flex-col justify-end items-center max-lg:min-w-0 max-lg:h-[55vh] max-lg:min-h-[350px] max-lg:flex-auto max-lg:w-auto max-sm:min-w-0 max-sm:w-full max-sm:h-auto max-sm:min-h-[320px]"
